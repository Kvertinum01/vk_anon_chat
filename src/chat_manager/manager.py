...
class ChatManager:
    ...
    def check_active_chats(self, user_id: int) -> bool:
        for curr_chat in self._active_chats:
            if user_id in curr_chat:
                return True
        return False
